...
import bannerSecond from "@images/banner-asics-2.jpg";
import bannerThird from "@images/banner-asics-3.jpg";
            ...
            <Slider className="">
              <Slide className="" index={0}>
                ...
                <div className=" w-full h-full">
                  ...
                  <div className="relative w-full h-full lg:block hidden">
                    <img
                      src="https://th.bing.com/th/id/R.9ec634ab2b1417a6530aa0a3cd458bf6?rik=AVYyEQiQTUL5zQ&riu=http%3a%2f%2frunnerclick.com%2fwp-content%2fuploads%2f2016%2f06%2fAsics-Running-Shoes-banner.jpg&ehk=pTMfTQXtT3rfAJCPSuMSi20jxFkAy0OLtcTspci5yTY%3d&risl=&pid=ImgRaw&r=0"
                      alt="sitting area"
                      className="object-center object-cover w-full h-full"
                    />
                    {/* <div className="pl-6 pb-6 lg:pl-8 lg:pb-8 absolute left-0 bottom-0">
