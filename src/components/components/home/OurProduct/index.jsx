...
import Kayano from "@images/asics-gelkayano-27.webp";
import asicsGT from "@images/asics-gt-1000.jpg";
import cumulus from "@images/asics-cumulus.jfif";
...
export default function OurProduct() {
  return (
    <div className="flex justify-center">
      <div className=" py-12 w-full lg:w-4/5">
