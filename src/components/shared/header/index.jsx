...
const Header = () => {
  ...
  return (
    <div className="grid grid-cols-1  lg:flex lg:justify-between dark:bg-gray-900 mx-5 lg:mx-20">
      <div className="flex justify-between items-center ">
        <Logo />
        <div className="hidden md:block md:mr-20 lg:hidden">
          <SearchBar />
        </div>
        <div className="cursor-pointer lg:hidden">
          <i className="text-xl fa-solid fa-bars md:text-3xl"></i>
        </div>
      </div>
      <div className="flex justify-center mb-5 lg:mb-0 lg:flex-1 "><Navbar /></div>
          ...
          <div className="w-full">
            <div className="flex items-center justify-between border-b border-gray-200 dark:border-gray-700 pb-3 mx-4">
              <div role="img" aria-label="Luxe. Logo">
                <div>
                  <svg
                    className="fill-stroke text-primary-v1 dark:text-white"
                    width={37}
                    height={17}
                    viewBox="0 0 37 17"
                    fill="none"
