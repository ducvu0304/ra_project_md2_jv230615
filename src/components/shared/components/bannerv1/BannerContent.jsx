export default function BannerContent() {
  return (
    <div className="relative mb-[20px] h-[269px] md:h-[500px] ">
      ...
      />
      <div className="absolute inset-0 grid h-full w-full place-items-center bg-black opacity-60 "></div>
      <div className="absolute bottom-[70px] w-full h-[150px] lg:bottom-[150px] xl:bottom-[100px] ">
        <div className="px-[40px]">
          ...
          <button className="w-full bg-white py-[10px] text-black font-bold mt-[20px]">
            SHOP NOW
          </button>
        </div>
      </div>
