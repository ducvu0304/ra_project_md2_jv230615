...
export default function WomenPage() {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      const response = await api.products.findAllProductsByGender("WOMEN");
  ...
  return (
    <div className="bg-[#f7f7f7] pb-6">
      ...
      <div className="grid grid-cols-1 mx-10 md:grid-cols-2 pt-4 lg:grid-cols-3 2xl:grid-cols-4">
        {products.map((item) => (
